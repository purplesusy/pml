...
dm <- data.frame(word = 
                   c('data', 'art', 'job', 'apple', 'fine', 
                     'experts', 'algorithms', 'historians', 'microscope', 'deep',
                     'javascript', 'analytics', 'courses', 'gaming', 'future',
                     'techniques', 'scalable', 'startup', 'change', 'technology'),
                 freq = c(80,70,60,50,40,30,20,10,10,10,10,10,8,8,8,8,6,6,3,2))    
